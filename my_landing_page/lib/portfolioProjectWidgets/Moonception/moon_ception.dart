...
import 'package:my_landing_page/portfolioProjectWidgets/Moonception/project_blog.dart';
import 'package:my_landing_page/portfolioProjectWidgets/Moonception/project_brief.dart';
import 'package:my_landing_page/portfolioProjectWidgets/Moonception/project_slide_1.dart';
...
class MoonCeption extends StatelessWidget {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    for (var project in projects) {
      if (project.projectName == 'TOWARD MOONCEPTION') {
