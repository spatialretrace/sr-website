...
import 'package:my_landing_page/portfolioProjectWidgets/Max_The_Spider/project_blog.dart';
import 'package:my_landing_page/portfolioProjectWidgets/Max_The_Spider/project_brief.dart';
import 'package:my_landing_page/portfolioProjectWidgets/Max_The_Spider/project_slide_1.dart';
...
class MaxTheSpider extends StatelessWidget {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    for (var project in projects) {
      if (project.projectName == 'SPIDER MAXIMILLIAN') {
